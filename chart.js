...
function recalculate() {
  ...
  results.innerHTML = `
    ...
    <b>Operator Engaged Time / Shift:</b> ${parseInt(operatorEngaged)} sec or ${parseInt(operatorEngaged) / 60} min <br>
    <b>Operator Idle Time / Shift:</b> ${parseInt(operatorIdle)} sec  or  ${parseInt(operatorIdle) / 60} min <br>
  `;
