...
function recalculate() {
  ...
  results.innerHTML = `
    ...
    <b>Components / Day:</b> ${componentsDay}<br>
    <b>Components / Month:</b> ${componentsMonth}<br><br>
    <b>Operator Engaged Time / Shift:</b> ${operatorEngaged} sec<br>
    <b>Operator Idle Time / Shift:</b> ${operatorIdle} sec
  `;
